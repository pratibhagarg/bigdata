...
public class WordCountDriver extends Configured implements Tool{ //changed
	...
	public int run(String[] args) throws Exception {
		...
		return job.waitForCompletion(true)?0:1; //changed
	}
	...
	public static void main(String[] args) throws Exception {
		...
		int status=ToolRunner.run(new WordCountDriver(), args); //changed
		System.exit(status);
