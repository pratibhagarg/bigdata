...
public class WordCountDriver {
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		//conf.set("mapreduce.job.reduces","0"); //1.1)for 0 reducer
		...
		//job.setNumReduceTasks(0);  //1.2)for 0 reducer
		
		
		//2) using combiner::
		//job.setCombinerClass(WordCountReducer.class); //using same reducer class
		
		 job.setNumReduceTasks(10);			//3) more than one reducer
